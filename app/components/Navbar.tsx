...
export default function Navbar() {
  ...
  return (
    <div>
      <div className='flex flex-row items-center justify-between w-full h-20 bg-black text-white px-2 md:px-20 fixed z-0'>
        <Image src={logoBarra} alt="" width={170} height={40} /> 
        <Link href={'/SignIn'} passHref >
          <div className='flex items-center justify-center bg-green-500 rounded hover:bg-green-800 transition duration-150 ease-in-out w-24 h-6 md:ml-96'>
            <span className='text-white text-xs font-normal'>Login</span>
          </div>             
        </Link>             
